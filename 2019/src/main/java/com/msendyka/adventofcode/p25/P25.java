package com.msendyka.adventofcode.p25;
...
public class P25 {
    ...
    public static void main(String[] args) {
        List<String> input = List.ofAll(Arrays.asList(Functions.readInput("p25/input.txt").head().split(",")));
